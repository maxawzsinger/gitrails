...
export const endpoint: EndpointObject<typeof requestSchema> = {
  ...
  executeRequest: async (request) => {
    ...
    const tree = parseStringifiedJson(
      request.stringifiedTree,
      "stringifiedTree",
      treeSchema,
    );
